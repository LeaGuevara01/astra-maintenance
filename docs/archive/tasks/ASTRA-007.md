...
> Estado: archivado el 2026-09-16. Origen: `docs/ASTRA-007.md`.
> Este documento conserva el contrato y los resultados históricos del dry-run; no define el flujo vigente.
> Consultar [`../../01-architecture/adr/README.md`](../../01-architecture/adr/README.md), [`../../API-CONTRACT.md`](../../API-CONTRACT.md) y [`../../HANDOFF.md`](../../HANDOFF.md).
