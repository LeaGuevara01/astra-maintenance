...
> Estado: archivado el 2026-09-16. Origen: `docs/ASTRA-006.md`.
> Este documento conserva evidencia de un incremento anterior y no define el flujo vigente.
> Consultar [`../../02-domains/technical-information/corpus-policy.md`](../../02-domains/technical-information/corpus-policy.md), [`../../03-interfaces/backend-architecture.md`](../../03-interfaces/backend-architecture.md) y [`../../HANDOFF.md`](../../HANDOFF.md).
